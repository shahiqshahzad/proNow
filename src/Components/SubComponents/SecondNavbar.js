...
const SecondNavbar = () => {
  ...
  const [messageProfileOpen, setmessageProfileOpen] = useState(false);
  function expand() {
  ...
  function messageProfileHandler() {
                    ...
                    <div className="px-1">
                      ...
                      <div className="secondnavbar-notifications_dd">
                        {/* <ul className="secondnavbar-messagebox_ul">
                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">MyBackapck</Link>
                            </div>
                          </li>

                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">Comments</Link>
                            </div>
                          </li>

                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">Notification</Link>
                            </div>
                          </li>

                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">My Posts</Link>
                            </div>
                          </li>

                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">Contact Us</Link>
                            </div>
                          </li>
                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">Terms & Conditions</Link>
                            </div>
                          </li>

                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">User Chat List</Link>
                            </div>
                          </li>
                          <li>
                            <div className="secondnavbar-messagebox-data">
                              <Link to="/MyBackpack">Logout</Link>
                            </div>
                          </li>
                        </ul> */}
                      </div>
